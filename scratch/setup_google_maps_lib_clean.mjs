...
// 2. Write apps/mobile/src/lib/googleMaps.ts
...
console.log('✅ Google Maps lib and env files configured.');
`;

fs.writeFileSync(path.join(projectRoot, 'scratch', 'setup_google_maps_lib_clean.mjs'), googleMapsTsScriptCode, 'utf8');
