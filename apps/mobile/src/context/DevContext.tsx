...
export const INITIAL_COUPLE_EVENTS: CoupleEvent[] = [
  ...
  },
  {
    ...
    ownerView: {
      title: '✨ Aniversario de cuando nos conocimos (Valencia)',
      subtitle: '23 de Noviembre de 2024 · Ent. Rico, 6, Quatre Carreres · La noche que lo empezó todo.',
  ...
  },
  {
    ...
    date: '2026-12-05',
    time: '21:00',
    actualStartAt: '2026-12-05T21:00:00',
    ownerView: {
      title: '🍽️ Nuestra Primera Cita · Alqueria del Pou',
      subtitle: "Diciembre 2024 · Restaurante Alqueria del Pou (Ent. del Pou d'Aparisi, 2) · La noche donde supimos que esto era especial.",
