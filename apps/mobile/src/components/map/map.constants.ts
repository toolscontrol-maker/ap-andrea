...
export const DEMO_MAP_PLACES: AndreaMapPlace[] = [
  ...
  },
  {
    ...
    subtitle: 'Cerca de la Ciudad de las Artes y las Ciencias, Valencia',
    description: 'Nuestra primera cita oficial en el restaurante El Pou. Risas, confidencias y donde supimos que queríamos estar juntos.',
    latitude: 39.4580,
    longitude: -0.3540,
    precision: 'exact',
    date: 'Diciembre, 2024',
